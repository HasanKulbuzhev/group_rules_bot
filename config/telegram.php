...
return [
    ...
    */
    ...
    'madelineProto' => [
        'session_name' => env('TELEGRAM_SESSION_FILE', 'madeline-session'),
    ...
    'chats' => [
        'channel_vince' => env('TELEGRAM_CHANNEL_ID'),
        'channel_test' => env('TELEGRAM_TEST_CHANNEL_ID'),
    ],
